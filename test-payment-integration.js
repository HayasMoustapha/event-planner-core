/**
 * SCRIPT DE TEST D'INTÉGRATION PAYMENT SERVICE
 * 
 * OBJECTIF : Tester la communication entre event-planner-core et payment-service
 * Ce script vérifie que l'intégration des paiements fonctionne correctement
 * 
 * UTILISATION :
...
async function runAllTests() {
  log('🚀 DÉMARRAGE DES TESTS D\'INTÉGRATION PAYMENT', 'yellow');
  log('==============================================', 'yellow');
