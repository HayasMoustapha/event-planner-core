...
class DatabaseBootstrap {
  ...
  /**
   * Crée la base de données event_planner_core si elle n'existe pas
   */
  ...
  async verifySeedIntegrity() {
    ...
    try {
      ...
      const basicTables = ['service_config', 'audit_logs'];
      ...
      console.log(`📊 Tables de base existantes: ${existingTables.length}/${basicTables.length}`);
      console.log('✅ Base de données initialisée avec succès');
      
      return {
        success: true,
        tables: existingTables,
        message: 'Base de données prête à l\'emploi'
      };
