...
COMMENT ON TABLE service_config IS 'Configuration du service Event Planner Core';
COMMENT ON TABLE audit_logs IS 'Journal d'audit pour Event Planner Core';

-- Insertion de la configuration de base
INSERT INTO service_config (key, value, description) VALUES 
('service_name', 'Event Planner Core', 'Nom du service'),
